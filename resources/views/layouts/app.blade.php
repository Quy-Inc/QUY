...
<script type="text/javascript" src="{!!asset('public/assets/jquery.ytLoad-master/jquery.transit.js')!!}"></script>
<script type="text/javascript" src="{!!asset('public/assets/jquery.ytLoad-master/ytLoad.jquery.js')!!}"></script>
...
<!-- CSS Stylesheet-->
<link href="{!!asset('public/assets/jquery.ytLoad-master/ytLoad.jquery.css')!!}" rel="stylesheet" type="text/css">
...
<div id="wrapper">
		...
		<div id="header">
				...
				<div class="logo-area clearfix">
						<a href="#" class="logo" style="background: url({!!env('APP_LOGO_HOME')!!}) no-repeat center center;"></a>
				</div>
				<!-- //logo-area-->
				...
				<div class="tools-bar">
						...
						<ul class="nav navbar-nav navbar-right tooltip-area">
								<li><a href="#" class="avatar-header" data-toggle="tooltip" data-container="body" data-placement="bottom">
												<img alt="" src="{!!Gravatar::src(Auth::user()->email) !!}"  class="circle">
										</a>
								</li>
								<li class="dropdown">
										...
										<ul class="dropdown-menu pull-right icon-right arrow">
												<li><a href="{!!url('users/edituser/')!!}/{!!Auth::user()->_id!!}" class='ajax-load'><i class="fa fa-user"></i> Profile</a></li>
												<li class="divider"></li>
