...
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"edituser"):''!!}
	<section class="panel">
			...
			<div class="panel-body">
				{{ Form::open(array('url' => '/ajax/stores/editstoresd','class'=>'form-horizontal','id'=>'feditstores')) }}
				{{Form::hidden("idstores",$id)}}
				
				<div class="form-group">
					{{ Form::label('ID Venues','',['class'=>'control-label col-md-3']) }}
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('id_venues',$datamodul->id_store,['class'=>'form-control','disabled'=>'disabled']) }}
						</div>
					</div>
				</div>
				<div class="form-group">
					{{ Form::label('Venue Name','',['class'=>'control-label col-md-3']) }}
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('storename',$datamodul->store_name,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Name Must Be Fill In']) }}
						</div>
					</div>
				</div>
				<div class="form-group">
					{{ Form::label('Venue Caption','',['class'=>'control-label col-md-3']) }}
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('storecaption',$datamodul->caption,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Caption Must Be Fill In']) }}
						</div>
					</div>
				</div>
				...
				<div class="form-group offset">
						<div class="col-md-offset-3 col-md-9">
								{{ Form::submit('Update Stores',['class'=>'btn btn-theme','id'=>'beditstores']) }}
								
								<button type="reset" class="btn" id="reset" onclick="$( '.stores' ).trigger( 'click')">Back</button>
						</div>
				</div>
				{{ Form::close() }}
			</div>
...
$(function(){
    ...
    var attrStoresUrl = "{!!url('stores/venues')!!}"+"/"+idMerchant+"-"+idVenue;
    var attrStoresUrlAdd = "{!!url('stores/addstores')!!}"+"/"+idMerchant+"-"+idVenue;

    $(".stores").attr('href',attrStoresUrl);
    $(".addstores").attr('href',attrStoresUrlAdd);
	...
	$("#feditstores").submit(function(event){
