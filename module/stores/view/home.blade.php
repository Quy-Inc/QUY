...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'stores'):''!!}
				<section class="panel">
...
$(function() {
	...
	$('#tstores').DataTable({
		processing: true,
		serverSide: true,
		ajax: '{!!url("/ajax/stores/getstores")!!}',
...
$(document).on('click','.showmodaldelstores', function(e){
	...
	$modal.find(".modal-body").html("Are you sure want to delete stores data?");
...
$(document).on('click','.yesdelstores', function(e){
	...
	$.ytLoad();
	var uri = "{!!url('ajax/stores/deletestoresd')!!}";
	$.ajax({
