...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addstores"):''!!}
	<section class="panel">
		...
		<div class="panel-body">
			{{ Form::open(array('url' => '/ajax/stores/addstoresd','class'=>'form-horizontal parsley-validated','id'=>'fstores')) }}
			<input type='hidden' name='id_merchants' value='{!!$idMerchant!!}' />
			<input type='hidden' name='id_venues' value='{!!$idVenue!!}' />
			<div class="form-group">
				{{ Form::label('Store Name','',['class'=>'control-label col-md-3']) }}
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('storename','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Name Must Be Fill In']) }}
					</div>
				</div>
			</div>
			<div class="form-group">
				{{ Form::label('Store Caption','',['class'=>'control-label col-md-3']) }}
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('storecaption','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Caption Must Be Fill In']) }}
					</div>
				</div>
			</div>
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							{{ Form::submit('Add Stores',['class'=>'btn btn-theme','id'=>'bstores']) }}
...
$(function(){
    ...
    var attrStoreUrl = "{!!url('stores/venues')!!}"+"/"+idMerchant+"-"+idVenue;
    var attrStoreUrlAdd = "{!!url('stores/addstores')!!}"+"/"+idMerchant+"-"+idVenue;
