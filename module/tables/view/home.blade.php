...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'tables'):''!!}
				<section class="panel">
...
$(function() {
	...
	$('#ttables').DataTable({
		processing: true,
		serverSide: true,
		ajax: '{!!url("/ajax/tables/gettables")!!}',
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "{!!url('ajax/tables/updatetablesd')!!}";
				$.ajax({
...
$(document).on('click','.showmodaldeltables', function(e){
	...
	$modal.find(".modal-body").html("Are you sure want to delete tables data?");
