...
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"edituser"):''!!}
	<section class="panel">
			...
			<div class="panel-body">
				{{ Form::open(array('url' => '/ajax/venues/editvenuesd','class'=>'form-horizontal','id'=>'feditvenues')) }}
				{{Form::hidden("idvenues",$id)}}

				<div class="form-group">
					{{ Form::label('ID Venues','',['class'=>'control-label col-md-3']) }}
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('id_venues',$datamodul->id_venues,['class'=>'form-control','disabled'=>'disabled']) }}
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('venuename',$datamodul->venues_name,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Venue Name Must Be Fill In']) }}
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							{{ Form::text('venuecaption',$datamodul->caption,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Venue Caption Must Be Fill In']) }}
						</div>
					</div>
				</div>
				...
				<div class="form-group offset">
						<div class="col-md-offset-3 col-md-9">
								{{ Form::submit('Update Venues',['class'=>'btn btn-theme','id'=>'beditvenues']) }}
...
$(function(){
    ...
    var attrVenuesUrl = "{!!url('venues/merchants')!!}"+"/"+idMerchant;
    var attrVenuesUrlAdd = "{!!url('venues/addvenues')!!}"+"/"+idMerchant;
