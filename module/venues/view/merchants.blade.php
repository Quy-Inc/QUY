...
@endphp
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'venues'):''!!}
				<section class="panel">
						...
						<div class="panel-body">
							<table class="table table-striped" id="tvenues" >
								<thead>
										<tr>
											<th>ID Venues</th>
											<th>Venues Name</th>
	...
	$('#tvenues').DataTable({
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "{!!url('ajax/venues/updatevenuesd')!!}";
				$.ajax({
...
//Delete Confirm
var $modal = $('#md-normal');
$(document).on('click','.showmodaldelvenues', function(e){
	e.preventDefault();
	e.stopPropagation();
	e.stopImmediatePropagation();
	var valueid = $(this).attr('valueajax');
	$modal.find(".modal-title").html("Delete Venues");
	$modal.find(".modal-body").html("Are you sure want to delete venues data?");
...
$(document).on('click','.showmodaldetailvenues', function(e){
	e.preventDefault();
	e.stopPropagation();
	e.stopImmediatePropagation();
	var valueid = $(this).attr('valueajax');
	...
	var uri = "{!!url('venues/detailvenues')!!}";
	$.ajax({
...
//Deleted Data
$(document).on('click','.yesdelvenues', function(e){
	e.preventDefault();
	e.stopPropagation();
	e.stopImmediatePropagation();
	var valueid = $(this).attr('valueajax');
	...
	$.ytLoad();
	var uri = "{!!url('ajax/venues/deletevenuesd')!!}";
	$.ajax({
