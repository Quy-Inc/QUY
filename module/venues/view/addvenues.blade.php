...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addvenues"):''!!}
	<section class="panel">
		...
		<div class="panel-body">
			{{ Form::open(array('url' => '/ajax/venues/addvenuesd','class'=>'form-horizontal parsley-validated','id'=>'fvenues')) }}
			<input type='hidden' name='id_merchants' value='{!!$data!!}' />
			<div class="form-group">
				{{ Form::label('Venue Name','',['class'=>'control-label col-md-3']) }}
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('venuename','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Venue Name Must Be Fill In']) }}
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('venuecaption','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Venue Caption Must Be Fill In']) }}
					</div>
				</div>
			</div>
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							{{ Form::submit('Add Venues',['class'=>'btn btn-theme','id'=>'bvenues']) }}
