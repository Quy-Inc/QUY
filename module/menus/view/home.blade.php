...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'menus'):''!!}
				<section class="panel">
	...
	$('#tmenus').DataTable({
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "{!!url('ajax/menus/updatemenusd')!!}";
				$.ajax({
...
$(document).on('click','.yesdelmenus', function(e){
	...
	$.ytLoad();
	var uri = "{!!url('ajax/menus/deletemenusd')!!}";
	$.ajax({
