...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'profiles'):''!!}
				<section class="panel">
...
$(function() {
	...
	$('#users-table').DataTable({
		processing: true,
		serverSide: true,
		ajax: '{!!url("/ajax/profiles/getprofilesdata")!!}',
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "{!!url('ajax/profiles/updatestatusprofiledata')!!}";
				$.ajax({
...
$(document).on('click','.yesdel', function(){
	...
	$.ytLoad();
	var uri = "{!!url('ajax/profiles/deleteprofiledata')!!}";
	$.ajax({
