...
<div id="content" style="padding-top: 0px;">
	<div class="row">
{!!(isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addmenucategories"):''!!}
	<section class="panel">
		...
		<div class="panel-body">
			{{ Form::open(array('url' => '/ajax/menucategories/addmenucategoriesd','class'=>'form-horizontal parsley-validated','id'=>'fmenucategories')) }}
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('category_name','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Category Name Must Be Fill In']) }}
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('caption','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Caption Category Must Be Fill In']) }}
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						{{ Form::text('extra_information','',['class'=>'form-control']) }}
					</div>
				</div>
			</div>
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							{{ Form::submit('Add Category',['class'=>'btn btn-theme','id'=>'bmenucategories']) }}
