...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'tables'):''; ?>
...
$(function() {
	...
	$('#ttables').DataTable({
		processing: true,
		serverSide: true,
		ajax: '<?php echo url("/ajax/tables/gettables"); ?>',
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "<?php echo url('ajax/tables/updatetablesd'); ?>";
				$.ajax({
