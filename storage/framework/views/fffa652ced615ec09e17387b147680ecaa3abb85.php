		...
		<div id="content" style="padding-top: 0px;">
		    <div class="row">
		        <?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'mitraTa'):''; ?>
		        ...
		        <section class="panel">
		            ...
		            <div class="panel-body">
		                <table class="table table-striped" id="tmitraTa">
		                    <thead>
		                        <tr>
		                            <th>Kode Mitra</th>
		                            <th>Nama Mitra</th>
...
$(function() {
    ...
    $('#tmitraTa').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url("/ajax/mitraTa/getmitraTa"); ?>',
        ...
        "fnDrawCallback": function(oSettings) {
            ...
            $('.switch').change(function(event) {
                ...
                $.ytLoad();
                var uri = "<?php echo url('ajax/mitraTa/updatemitraTad'); ?>";
                $.ajax({
                    url: uri,
                    data: {
                        'data': dataid,
...
//Delete Confirm
var $modal = $('#md-normal');
$(document).on('click', '.showmodaldelmitraTa', function(e) {
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();
    var valueid = $(this).attr('valueajax');
    $modal.find(".modal-title").html("Delete MitraTa");
    $modal.find(".modal-body").html("Are you sure want to delete mitraTa data?");
    $modal.find(".modal-footer").html(
        '<button type="button" class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">Tutup</button><button type="button" class="btn btn-danger  yesdelmitraTa" valueajax="' +
...
//Deleted Data
$(document).on('click', '.yesdelmitraTa', function(e) {
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();
    var valueid = $(this).attr('valueajax');
    ...
    $.ytLoad();
    var uri = "<?php echo url('ajax/mitraTa/deletemitraTad'); ?>";
    $.ajax({
        url: uri,
        data: {
            'data': valueid,
