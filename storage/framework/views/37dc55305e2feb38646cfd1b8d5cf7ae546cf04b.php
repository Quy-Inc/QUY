...
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"edituser"):''; ?>
	...
	<section class="panel">
			...
			<div class="panel-body">
				<?php echo e(Form::open(array('url' => '/ajax/stores/editstoresd','class'=>'form-horizontal','id'=>'feditstores'))); ?>

				<?php echo e(Form::hidden("idstores",$id)); ?>
				...
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							<?php echo e(Form::text('id_venues',$datamodul->id_store,['class'=>'form-control','disabled'=>'disabled'])); ?>
				...
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							<?php echo e(Form::text('storename',$datamodul->store_name,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Name Must Be Fill In'])); ?>
				...
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							<?php echo e(Form::text('storecaption',$datamodul->caption,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Store Caption Must Be Fill In'])); ?>
				...
				<div class="form-group offset">
						<div class="col-md-offset-3 col-md-9">
								<?php echo e(Form::submit('Update Stores',['class'=>'btn btn-theme','id'=>'beditstores'])); ?>
...
$(function(){
    ...
    var attrStoresUrl = "<?php echo url('stores/venues'); ?>"+"/"+idMerchant+"-"+idVenue;
    var attrStoresUrlAdd = "<?php echo url('stores/addstores'); ?>"+"/"+idMerchant+"-"+idVenue;
