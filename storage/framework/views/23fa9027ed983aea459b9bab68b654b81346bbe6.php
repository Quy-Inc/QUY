...
$(function() {
	...
	$('#tvenues').DataTable({
		...
		serverSide: true,
		ajax: {
            url:'<?php echo url("/ajax/venues/getvenues"); ?>',
		...
		"fnDrawCallback": function (oSettings) {
			...
			$('.switch').change(function (event) {
				...
				$.ytLoad();
				var uri = "<?php echo url('ajax/venues/updatevenuesd'); ?>";
				$.ajax({
...
$(document).on('click','.showmodaldetailvenues', function(e){
	...
	var uri = "<?php echo url('venues/detailvenues'); ?>";
	$.ajax({
...
$(document).on('click','.yesdelvenues', function(e){
	...
	$.ytLoad();
	var uri = "<?php echo url('ajax/venues/deletevenuesd'); ?>";
	$.ajax({
