...
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"edituser"):''; ?>
	...
	<section class="panel">
			...
			<div class="panel-body">
				<?php echo e(Form::open(array('url' => '/ajax/menus/editmenusd','class'=>'form-horizontal','id'=>'feditmenus'))); ?>

				<?php echo e(Form::hidden("idmenus",$id)); ?>

					
								
					<div class="form-group offset">
							<div class="col-md-offset-3 col-md-9">
									<?php echo e(Form::submit('Update Menus',['class'=>'btn btn-theme','id'=>'beditmenus'])); ?>
