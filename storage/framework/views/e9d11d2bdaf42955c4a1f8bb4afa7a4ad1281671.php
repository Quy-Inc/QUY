		...
		<div class="panel-body">
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							<?php echo e(Form::submit('Add Psbmarketing',['class'=>'btn btn-theme','id'=>'bpsbmarketing'])); ?>

							
							<button type="reset" class="btn" id="reset" onclick="$( '.psbmarketing' ).trigger( 'click')">Back</button>
					</div>
			</div>
