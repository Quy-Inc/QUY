...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addtables"):''; ?>
	...
	<section class="panel">
		...
		<div class="panel-body">
			<?php echo e(Form::open(array('url' => '/ajax/tables/addtablesd','class'=>'form-horizontal parsley-validated','id'=>'ftables'))); ?>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						<?php echo e(Form::text('table_code','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Table Code Must Be Fill In'])); ?>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						<?php echo e(Form::text('table_name','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Table Name Must Be Fill In'])); ?>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						<?php echo e(Form::text('description','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Description Must Be Fill In'])); ?>
			...
			<div class="form-group">
				...
				<div class="row col-md-9">
					<div class="col-md-6">
						<?php echo e(Form::text('extra_information','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Extra Information Must Be Fill In'])); ?>
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							<?php echo e(Form::submit('Add Tables',['class'=>'btn btn-theme','id'=>'btables'])); ?>
