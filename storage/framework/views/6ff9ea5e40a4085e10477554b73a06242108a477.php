...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addmenus"):''; ?>
	...
	<section class="panel">
		...
		<div class="panel-body">
			<?php echo e(Form::open(array('url' => '/ajax/menus/addmenusd','class'=>'form-horizontal parsley-validated','id'=>'fmenus'))); ?>

			<div class="col-md-6">
				<input type='hidden' name='id_merchant' value='<?php echo e($data); ?>' />
				<div class="form-group">
					<?php echo e(Form::label('Kitchen','',['class'=>'control-label col-md-2'])); ?>
					...
					<div class="row col-md-10">
						<div class="col-md-12">
							...
							?>
								<?php echo e(Form::select('id_kitchen',array('' => 'Choice Kitchen') +$kitchen,'',['class'=>"selectpicker form-control",'data-live-search'=>'true','data-limit'=>'8','parsley-required'=>"true",'parsley-required-message'=>"Kitchen Must Be Choice",'id'=>'kitchen','parsley-error-container'=>'#ekitchen'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Category','',['class'=>'control-label col-md-2'])); ?>
					...
					<div class="row col-md-10">
						<div class="col-md-12">
							...
							?>
								<?php echo e(Form::select('id_category',array('' => 'Choice Category') +$kitchen,'',['class'=>"selectpicker form-control",'data-live-search'=>'true','data-limit'=>'8','parsley-required'=>"true",'parsley-required-message'=>"Category Must Be Choice",'id'=>'category','parsley-error-container'=>'#ecategory'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Menu Code','',['class'=>'control-label col-md-2'])); ?>

					<div class="row col-md-10">
						<div class="col-md-12">
							<?php echo e(Form::text('menu_code','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Menu Code Must Be Fill In'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Menu Name','',['class'=>'control-label col-md-2'])); ?>

					<div class="row col-md-10">
						<div class="col-md-12">
							<?php echo e(Form::text('menu_name','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Menu Name Must Be Fill In'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Caption','',['class'=>'control-label col-md-2'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Description','',['class'=>'control-label col-md-2'])); ?>
			...
			<div class='col-md-6'>
				<div class="form-group">
					<?php echo e(Form::label('Component','',['class'=>'control-label col-md-2'])); ?>

					<div class="row col-md-10">
						<div class="col-md-4">
							<?php echo e(Form::text('componentname_','',['placeholder'=>'Name','class'=>'form-control namecomponent'])); ?>

						</div>
						<div class="col-md-3">
							<?php echo e(Form::text('componentamount_','',['placeholder'=>'Amount','class'=>'form-control amountcomponent'])); ?>

						</div>
						<div class="col-md-4">
							<?php echo e(Form::text('componentvalue_','',['placeholder'=>'Value','class'=>'form-control valuecomponent'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Add On Alternative','',['class'=>'control-label col-md-2'])); ?>

					<div class="row col-md-10">
						<div class="col-md-4">
							<?php echo e(Form::text('addonalternativename_','',['placeholder'=>'Name','class'=>'form-control nameaddonalternative'])); ?>

						</div>
						<div class="col-md-3">
							<?php echo e(Form::text('addonalternativeamount_','',['placeholder'=>'Amount','class'=>'form-control amountaddonalternative'])); ?>

						</div>
						<div class="col-md-4">
							<?php echo e(Form::text('addonalternativevalue_','',['placeholder'=>'Value','class'=>'form-control valueaddonalternative'])); ?>
				...
				<?php echo e(Form::label('Photo','',['class'=>'control-label col-md-2'])); ?>
			...
			<div class="addphoto">	
				...
				<div class="form-group" style="margin-top:15px;">
					<?php echo e(Form::label('Price','',['class'=>'control-label col-md-2'])); ?>

					<div class="row col-md-10">
						<div class="col-md-4">
							<?php echo e(Form::number('price','',['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Price Must Be Fill In'])); ?>
			...
			<div class="form-group offset">
					<div class="col-md-offset-3 col-md-9">
							<?php echo e(Form::submit('Add Menus',['class'=>'btn btn-theme','id'=>'bmenus'])); ?>
...
$(function(){
    ...
    var attrMenusUrl = "<?php echo url('menus/menulists'); ?>"+"/"+idMerchant;
    var attrMenusUrlAdd = "<?php echo url('menus/addmenus'); ?>"+"/"+idMerchant;
