...
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"edituser"):''; ?>
	...
	<section class="panel">
			...
			<div class="panel-body">
				<?php echo e(Form::open(array('url' => '/ajax/menucategories/editmenucategoriesd','class'=>'form-horizontal','id'=>'feditmenucategories'))); ?>

				<?php echo e(Form::hidden("idmenucategories",$id)); ?>
				...
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							<?php echo e(Form::text('category_name',$datamodul->category_name,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Category Name Must Be Fill In'])); ?>
				...
				<div class="form-group">
					...
					<div class="row col-md-9">
						<div class="col-md-6">
							<?php echo e(Form::text('caption',$datamodul->caption,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Caption Category Must Be Fill In'])); ?>
				...
				<div class="form-group offset">
						<div class="col-md-offset-3 col-md-9">
								<?php echo e(Form::submit('Update Menucategories',['class'=>'btn btn-theme','id'=>'beditmenucategories'])); ?>
