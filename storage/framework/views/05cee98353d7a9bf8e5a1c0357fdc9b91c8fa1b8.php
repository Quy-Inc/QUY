...
$modul = new \Modules\tatelkom\models\Tatelkom;
    ...
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <?php echo e(Form::open(array('url' => '/ajax/tatelkom/edittatelkomd','class'=>'form-horizontal','id'=>'fedittatelkom'))); ?>

                <?php echo e(Form::hidden("idtatelkom",$id)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="row col-md-9">
                        <div class="col-md-6">
                            <?php echo e(Form::textarea('keterangan',$datamodul->keterangan,['class'=>'form-control parsley-validated','parsley-required'=>"true",'parsley-required-message'=>'Data tidak boleh kosong'])); ?>
                ...
                <div class="form-group offset">
                    <div class="col-md-offset-3 col-md-9">
                        <?php echo e(Form::submit('Update Data',['class'=>'btn btn-theme','id'=>'bedittatelkom'])); ?>
...
<script>
$(function() {
    $("#fedittatelkom").submit(function(event) {
