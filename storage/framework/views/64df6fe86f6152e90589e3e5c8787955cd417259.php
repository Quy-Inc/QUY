...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'stores'):''; ?>
...
$(function() {
	...
	$('#tstores').DataTable({
		processing: true,
		serverSide: true,
		ajax: '<?php echo url("/ajax/stores/getstores"); ?>',
...
$(document).on('click','.yesdelstores', function(e){
	...
	$.ytLoad();
	var uri = "<?php echo url('ajax/stores/deletestoresd'); ?>";
	$.ajax({
