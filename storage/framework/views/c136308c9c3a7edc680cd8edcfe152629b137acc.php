...
$(document).on('click','.showmodaldelsiswa', function(e){
	...
	$modal.find(".modal-footer").html('<button type="button" class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">Tutup</button><button type="button" class="btn btn-danger  yesdelsiswa" valueajax="'+valueid+'" >Setuju</button>');
	$modal.modal('show');
});
