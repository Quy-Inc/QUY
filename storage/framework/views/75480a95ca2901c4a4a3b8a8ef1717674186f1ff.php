		...
		<div id="content" style="padding-top: 0px;">
		    <div class="row">
		        <?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'biaya'):''; ?>
		        ...
		        <section class="panel">
		            ...
		            <div class="panel-body">
		                <table class="table table-striped" id="tbiaya">
		                    <thead>
		                        <tr>
		                            <th>Keterangan</th>
...
$(function() {
    ...
    $('#tbiaya').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url("/ajax/biaya/getbiaya"); ?>',
        ...
        "fnDrawCallback": function(oSettings) {
            ...
            $('.switch').change(function(event) {
                ...
                $.ytLoad();
                var uri = "<?php echo url('ajax/biaya/updatebiayad'); ?>";
                $.ajax({
                    url: uri,
                    data: {
                        'data': dataid,
...
//Delete Confirm
var $modal = $('#md-normal');
$(document).on('click', '.showmodaldelbiaya', function(e) {
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();
    var valueid = $(this).attr('valueajax');
    $modal.find(".modal-title").html("Delete Biaya");
    $modal.find(".modal-body").html("Are you sure want to delete biaya data?");
    $modal.find(".modal-footer").html(
        '<button type="button" class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">Tutup</button><button type="button" class="btn btn-danger  yesdelbiaya" valueajax="' +
...
//Deleted Data
$(document).on('click', '.yesdelbiaya', function(e) {
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();
    var valueid = $(this).attr('valueajax');
    ...
    $.ytLoad();
    var uri = "<?php echo url('ajax/biaya/deletebiayad'); ?>";
    $.ajax({
        url: uri,
        data: {
            'data': valueid,
