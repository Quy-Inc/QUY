...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,"addmerchants"):''; ?>
	...
	<section class="panel">
		...
		<div class="panel-body">
			<?php echo e(Form::open(array('url' => '/ajax/merchants/addmerchantsd','class'=>'form-horizontal parsley-validated','id'=>'fmerchants'))); ?>
				...
				<div class="form-group offset">
					...
					<div class="col-md-offset-3 col-md-9">
							<?php echo e(Form::submit('Add Merchants',['class'=>'btn btn-theme','id'=>'bmerchants'])); ?>
