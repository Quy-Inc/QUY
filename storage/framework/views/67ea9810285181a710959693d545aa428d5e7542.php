...
<div id="content" style="padding-top: 0px;">
	<div class="row">
<?php echo (isset($content))?Ozn::getSubMenuIcon($content->sub_menu,$content->module_slug,'modules'):''; ?>
...
$(function() {
	$('#module-table').DataTable({
		processing: true,
		serverSide: true,
		ajax: '<?php echo url("/ajax/modules/getdirectory"); ?>',
		 columns: [
...
$(document).on('click','.md-ajax-load', function(){
	  ...
	  $modal.find(".modal-body").load('<?php echo url("/ajax/modules/vrole_profile"); ?>', {"slug":$slug,"_token":"<?php echo e(csrf_token()); ?>"}, function(){
